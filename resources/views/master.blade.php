...
<head>
	<meta charset="UTF-8">
	<title>@yield('page_title','Halaman Awal') | Farr-Awayy</title>
...
<body>
		...
		<footer class="container">
			...
			created by <a href="https://www.facebook.com"><span><i class="fa fa-facebook" style="color:#1da1f2"></i> @Fajar Khairumman</span></a>
			<!--/ Please dont delete this -->
		</footer>	
		</nav>
